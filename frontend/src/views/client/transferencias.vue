    ...
    <div class="card shadow">
      <div class="card-header px-0 py-0">
        <div class="row align-items-center m-0 p-0 py-3 d-flex justify-content-between">
          <div class="col-auto">
            <strong>REPORTE DE TRANSFERENCIA</strong>
          </div>
        ...
        <div class="modal-body px-2 pt-0 mx-2 mt-0 mb-2">
          ...
          <div v-else>
            ...
            <div class="info-basica row my-1">
              <div class="col-md-6">
                <p class="my-1"><strong>Transferencia N°:</strong> {{ detalle.solicitud.consecutivo || 'N/A' }}</p>
...
export default {
  ...
  computed: {
    ...
    timelineSteps() {
      const moduloActual = this.detalle.solicitud.modulo || "transferencia";
  ...
  methods: {
    ...
    doc.setFontSize(18);
    doc.text("Reporte de Transferencia", marginLeft, currentY);
    currentY += 10;
    doc.setFontSize(11);
    doc.setTextColor(0);
    ...
    doc.text("Detalle de Transferencia", marginLeft, currentY);
    currentY += 7;
    doc.setFontSize(11);
    doc.setTextColor(0);
    ...
    // 9. Guarda el PDF
    doc.save(`Solicitud de Transferencia Nro- ${sol.id}.pdf`);
  },
    ...
    showDetalle(solicitudId, transportista, documentoIdentidad, placa, idTransferencia) {
      console.log("ID solicitud transferencia:", solicitudId, transportista, documentoIdentidad, placa, idTransferencia);
      ...
      apiClient
        ...
        .then(response => {
          ...
          this.detalle.solicitud.idTransferencia = idTransferencia || '';
