 ...
 */
async function createDesarchiveCabecera(transaction, data) {
 ...
 */
async function createDesarchiveDetalle(transaction, data) {
...
module.exports = {
  createDesarchiveCabecera,
  createDesarchiveDetalle
};