          ...
          <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <ul class="navbar-nav mx-auto my-2 my-lg-0" role="tablist">
              ...
              <li class="nav-item dropdown">
                ...
                <ul
                  class="dropdown-menu"
                  aria-labelledby="moviemientosDropdown"
                >
                  <li v-for="tabItem in movimientosTabs" :key="tabItem.name">
                    <a
                      class="dropdown-item"
            ...
            <div class="d-flex align-items-center">
              <NotificationsNavbar />
              <div
                class="me-3 pe-none d-none d-sm-flex align-items-center me-4"
              >
...
const Desincorporacion = defineAsyncComponent(() => import("./desarchive.vue"));
...
export default {
  ...
  computed: {
     breadcrumbPath() {
       if (this.currentTab === "Prestamo") {
         return [{ menu: "Reporte", submenu: this.currentTab }];
       } else if (this.currentTab === "Devolucion") {
         return [{ menu: "Reporte", submenu: this.currentTab }];
       } else if (this.currentTab === "Transferencia") {
